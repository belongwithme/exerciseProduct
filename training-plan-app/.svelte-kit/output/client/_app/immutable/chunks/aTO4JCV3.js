import"./CWj6FrbW.js";import{i as Ke}from"./BTdtOKhu.js";import{av as K,q as O,b as l,p as Oe,as as Qe,o as Ue,f as g,d as s,s as o,r as a,g as e,m as L,u as V,t as q,j as S,e as P,c as We,i,n as me,v as _e,y as Ye}from"./CDvu5KIv.js";import{i as y}from"./pr_9b7ab.js";import{e as Ze}from"./DtTT7JPL.js";import{s as er}from"./BrlEh5uC.js";import{l as Q,s as U,p as ye}from"./C6rgrwdz.js";import{s as rr}from"./x2EdFAPA.js";import{H as he}from"./D2aVQm2_.js";import{X as tr}from"./BmpHNf-a.js";import{s as W}from"./BMDv3NVz.js";import{I as Y}from"./fNyos_Jn.js";import{C as ar}from"./B1Bw7QfG.js";function sr(C,b){const f=Q(b,["children","$$slots","$$events","$$legacy"]);/**
...
此操作不可撤销。`)){i(_,!0),i(h,"");try{const{data:t,error:d}=await rr.rpc("revert_to_plan_version",{p_plan_id:parseInt(f().toString()),p_target_version_number:r});if(d)throw d;await Z(),m("revertSuccess",{message:`成功恢复到版本 ${r}`,newVersionNumber:t.new_version_number})}catch(t){console.error("恢复版本时发生错误:",t),i(h,`恢复版本失败: ${t instanceof Error?t.message:"未知错误"}`)}finally{i(_,!1)}}}function Me(){i(v,!0),i(x,null)}function ee(){i(v,!1),i(x,null)}function je(r){e(v)&&(e(x)===null?i(x,r):(m("compare",{version1:e(x),version2:r}),ee()))}function re(){m("close")}Ue(()=>{Z()}),Ke();var E=mr(),te=s(E),F=s(te),R=s(F),ae=s(R);he(ae,{class:"w-6 h-6 text-blue-600"});var se=o(ae,2),oe=o(s(se),2),Ve=s(oe,!0);a(oe),a(se),a(R);var G=o(R,2),Ce=s(G);tr(Ce,{class:"w-5 h-5"}),a(G),a(F);var T=o(F,2),ne=s(T);{var He=r=>{var t=ir(),d=s(t),z=s(d,!0);a(d),a(t),q(()=>S(z,e(h))),l(r,t)};y(ne,r=>{e(h)&&r(He)})}var ie=o(ne,2);{var ze=r=>{var t=lr(),d=s(t),z=s(d),k=o(s(z),2),w=s(k);{var I=$=>{var j=_e("请选择第一个要对比的版本");l($,j)},n=$=>{var j=_e();q(()=>S(j,`已选择版本 ${e(x)??""}，请选择第二个版本进行对比`)),l($,j)};y(w,$=>{e(x)===null?$(I):$(n,!1)})}a(k),a(z);var N=o(z,2);a(d),a(t),P("click",N,ee),l(r,t)};y(ie,r=>{e(v)&&r(ze)})}var Ie=o(ie,2);{var Ne=r=>{var t=dr();l(r,t)},De=(r,t)=>{{var d=k=>{var w=cr(),I=s(w);he(I,{class:"mx-auto h-12 w-12 text-gray-400"}),me(4),a(w),l(k,w)},z=k=>{var w=xr();Ze(w,5,()=>e(c),I=>I.id,(I,n)=>{var N=gr(),$=s(N),j=s($),A=s(j),B=s(A),de=s(B);or(de,{class:"w-4 h-4 text-blue-600"});var ce=o(de,2),qe=s(ce);a(ce),a(B);var ve=o(B,2);{var Ee=u=>{var M=vr();l(u,M)};y(ve,u=>{e(n),e(c),V(()=>e(n).version_number===Math.max(...e(c).map(M=>M.version_number)))&&u(Ee)})}var Fe=o(ve,2);{var Re=u=>{var M=ur();l(u,M)};y(Fe,u=>{e(v),e(x),e(n),V(()=>e(v)&&e(x)===e(n).version_number)&&u(Re)})}a(A);var ue=o(A,2),be=s(ue);ar(be,{class:"w-4 h-4"});var pe=o(be,2),Ge=s(pe,!0);a(pe),a(ue),a(j);var Te=o(j,2);{var Xe=u=>{var M=pr(),ge=s(M),Ae=o(ge,2);{var Be=J=>{var D=br(),xe=s(D);nr(xe,{class:"w-3 h-3"});var fe=o(xe,2),Je=s(fe,!0);a(fe),a(D),q(()=>{D.disabled=e(_),S(Je,e(_)?"恢复中...":"恢复")}),P("click",D,()=>$e(e(n).version_number)),l(J,D)};y(Ae,J=>{e(n),e(c),V(()=>e(n).version_number!==Math.max(...e(c).map(D=>D.version_number)))&&J(Be)})}a(M),P("click",ge,()=>we(e(n).version_number)),l(u,M)};y(Te,u=>{e(v)||u(Xe)})}a($),a(N),q(u=>{er(N,1,`bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 transition-colors cursor-pointer
								${e(v)?"hover:bg-blue-100 dark:hover:bg-blue-900/30":"hover:bg-gray-100 dark:hover:bg-gray-700"}
								${e(v),e(x),e(n),V(()=>e(v)&&e(x)===e(n).version_number?"bg-blue-100 dark:bg-blue-900/50 border border-blue-300 dark:border-blue-700":"")??""}`),S(qe,`版本 ${e(n),V(()=>e(n).version_number)??""}`),S(Ge,u)},[()=>(e(n),V(()=>ke(e(n).created_at)))],Ye),P("click",N,()=>e(v)?je(e(n).version_number):null),l(I,N)}),a(w),l(k,w)};y(r,k=>{e(c),V(()=>e(c).length===0)?k(d):k(z,!1)},t)}};y(Ie,r=>{e(p)?r(Ne):r(De,!1)})}a(T);var le=o(T,2),X=s(le),Pe=s(X);{var Le=r=>{var t=fr(),d=s(t);sr(d,{class:"w-4 h-4"}),me(2),a(t),P("click",t,Me),l(r,t)};y(Pe,r=>{e(v),e(c),V(()=>!e(v)&&e(c).length>=2)&&r(Le)})}a(X);var Se=o(X,2);a(le),a(te),a(E),q(()=>S(Ve,H()||`计划 #${f()}`)),P("click",G,re),P("click",Se,re),l(C,E),We()}export{Nr as default};
