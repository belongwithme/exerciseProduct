...
export interface Exercise {
  ...
  difficulty_level?: string; // 动作难度等级 (初级/中级/高级)
  type?: string; // 动作类型 (strength/cardio/flexibility/plyometric等)
  video_url?: string; // 示范视频链接
  image_url?: string; // 示范图片链接
  instructions?: string; // 动作指导
  tips?: string; // 训练提示
  is_system_exercise?: boolean; // 是否为系统预设动作
}
