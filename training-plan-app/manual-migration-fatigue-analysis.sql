...
-- 为函数设置适当的权限
GRANT EXECUTE ON FUNCTION calculate_fatigue_index TO authenticated;
GRANT EXECUTE ON FUNCTION get_fatigue_trend TO authenticated;
GRANT EXECUTE ON FUNCTION calculate_fatigue_index_for_date TO authenticated;

-- 完成提示
SELECT 'Fatigue analysis functions created successfully!' as status; 